...
const CATEGORIES = [
  ...
  { name: "Carbon Fiber",  desc: "Hoods, mirrors & trim",     color: "bg-gray-100   border-gray-400    hover:border-gray-600    hover:bg-gray-200"    },
  { name: "Trims",         desc: "Chrome & matte trims",      color: "bg-amber-50   border-amber-300   hover:border-amber-500   hover:bg-amber-100"   },
