...
export default function Footer() {
  ...
  <a href="https://www.tiktok.com/@snmotors207?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-zinc-800 hover:bg-black rounded-sm flex items-center justify-center transition-colors" title="TikTok">
